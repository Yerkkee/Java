...
public class StatsDemo
{
   ...
   public static void main(String[] args) throws IOException {
      ...
      FileWriter outputFile = new FileWriter("Results.txt");// Create a FileWriter object using "Results.txt"
      PrintWriter printWrite = new PrintWriter(outputFile);// Create a PrintWriter object passing the FileWriter object
      printWrite.printf("Mean: %.3f, standard deviation: %.3f",mean,stdDev);// Print the results to the output file
