...
public class Money
{
   ...
   */
   ...
   public Money(Money copyObject){
      dollars = copyObject.dollars;
      cents = copyObject.cents;
   }
   ...
   */
   ...
   public boolean equals(Money equalObject){
      boolean status;
      if(this.dollars == equalObject.dollars && this.cents == equalObject.cents){
         status = true;
      }
      else status = false;
      return status;
